...
from notion_client import typing
...
class DataSource(BaseNotion):
    def __init__(self, data_source_json: dict, client: "NotionAPI"):
        ...
        self.properties: List[Property] = [Property(title, prop_json, self.client) for title, prop_json in data_source_json["properties"].items()]
