...
class DataSource(BaseNotion):
    def __init__(self, data_source_json: dict, client: NotionAPI):
        ...
        self.title: Property = Property("title", data_source_json["title"])
        ...
        self.properties: List[Property] = [Property(title, prop_json) for title, prop_json in data_source_json["properties"].items()]
