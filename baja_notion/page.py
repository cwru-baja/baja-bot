...
class Page(BaseNotion):
    ...
    def _parse_json(self, page_json):
        ...
        self.properties: List[Property] = [
            Property(title, prop_values, self.client)
            for title, prop_values in page_json["properties"].items()
        ]
    ...
    async def update(self, property: Property, value: dict):
        ...
        # print(update_dict)
        await self.client.pages.update(self.id, properties=update_dict)
