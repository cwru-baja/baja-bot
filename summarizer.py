...
class Summarizer:
    ...
    async def get_sectioned_summary(self, channel_messages_dict: dict) -> str:
        ...
        system_instruction = (
            ...
            "9. OUTPUT ONLY THE SUMMARY: Do not include any preamble, intro, label, explanation, or closing sentence. Never start with phrases like 'Here is the summary' or 'Summary:'.\n\n"
            "Example format:\n"
            "## channel-name\n"
            "- Topic 1 discussed\n"
